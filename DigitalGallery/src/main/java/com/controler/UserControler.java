...
public class UserControler {
	...
	@RequestMapping(value = "DisplayProduct1", method = RequestMethod.GET)
	public ModelAndView showProductAdmin1() 
	{
		ModelAndView mvc = new ModelAndView("UserProductView1", "ProductAdmin", new ProductAdmin());
