...
<div  class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
	...
	<h2>Please See the all Products
	      <small>It's All and always will be for Admin</small>
	</h2>
<hr class="colorgraph">
				<div class="row">
					<div class="row">
						...
						<sf:input  path="prize"
									...
									tabindex="1" pattern=".{3,10}" required="true"
									title="minimum length for prize is 3"></sf:input>
				...
				<sf:input path="discrption"
									...
									<div class="form-group col-xs-6">
			  <sf:label path="categoryid">category Name</sf:label>
			  ...
			  <option ng-repeat="product in mylist1" value="{{product.categoryid}}">{{product.categoryName}}</option>
			      ...
			      <div class="form-group col-xs-6">
			  <sf:label path="supplierid">supplier Name</sf:label>
...
<thead>
				...
				<td><a href="#">{{product.productid}}</a></td>
					...
					<td><a href="#">{{product.prize}}</a></td>
					<td><a href="#">{{product.stock}}</a></td>
					<td><a href="#">{{product.categoryid}}</a></td>
					<td><a href="#">{{product.supplierid}}</a></td>
					<td><a href="#">{{product.discrption}}</a></td>
					<td><a href="Deleteproduct?pid={{product.productid}}">Delete</a></td>
					<td><a href="plzUpdatedproduct?pid={{product.productid}}">
					<img src="./resources/images/{{product.productid}}.jpg" height="50px" width="50px">Update</a></td>
